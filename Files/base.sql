...
-- -----------------------------------------------------
-- Table `system_user_has_system_resources`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `system_user_has_system_resources` ;

CREATE TABLE IF NOT EXISTS `system_user_has_system_resources` (
...
-- -----------------------------------------------------
-- Table `system_group_has_system_resources`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `system_group_has_system_resources` ;

CREATE TABLE IF NOT EXISTS `system_group_has_system_resources` (
  `system_group_id` INT UNSIGNED NOT NULL,
  `system_resources_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `system_user` (`id`, `username`, `password`, `name`, `email`, `avatar`, `create_date`, `update_date`, `delete_date`, `user_type`, `active`, `can_edit`, `can_login`, `can_use_web`, `can_use_api`, `system_group_id`) VALUES (1, 'test', 'pass', 'Test User', 'test@user.com', 'admin.png', '2016-04-16 20:00:00', NULL, NULL, 'M', 1, 1, 1, 1, 1, 1);
